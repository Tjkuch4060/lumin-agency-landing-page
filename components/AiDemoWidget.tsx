  ...
  return (
    <section id="ai-demo" className="bg-slate-50 py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-12 max-w-5xl mx-auto bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden grid md:grid-cols-3">
          {/* Chat Interface */}
          <div className="md:col-span-2 flex flex-col h-[600px]">
            <div className="flex-grow p-6 space-y-6 overflow-y-auto bg-slate-100/50">
            ...
            <div className="p-4 border-t border-slate-200 bg-white">
              ...
              <form onSubmit={handleFormSubmit} className="flex items-center gap-2">
                <input
                  ...
                  className="w-full h-11 px-4 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                />
                <button type="submit" className="h-11 px-5 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 disabled:bg-blue-300" disabled={isAiTyping}>
                  Send
                </button>
              </form>
            </div>
