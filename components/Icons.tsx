...
export const Triangle: React.FC<IconProps> = (props) => (
...
export const CodeIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" className="w-6 h-6" {...props}>
      <path fill="currentColor" d="M9.4 16.6L5.8 13l3.6-3.6l-1.4-1.4L3 13l5 5l1.4-1.4zm5.2 0l1.4 1.4l5-5l-5-5l-1.4 1.4L18.2 13l-3.6 3.6z"/>
    </svg>
);

export const GearIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" className="w-6 h-6" {...props}>
      <path fill="currentColor" d="M19.14 12.94a7.5 7.5 0 000-1.88l2.03-1.58a.5.5 0 00.12-.64l-1.92-3.32a.5.5 0 00-.6-.22l-2.39.96a7.6 7.6 0 00-1.63-.94l-.36-2.55a.5.5 0 00-.5-.42h-3.84a.5.5 0 00-.5.42l-.36 2.55c-.57.24-1.12.54-1.63.94l-2.39-.96a.5.5 0 00-.6.22L2.7 8.84a.5.5 0 00.12.64l2.03 1.58c-.05.62-.05 1.26 0 1.88L2.82 14.5a.5.5 0 00-.12.64l1.92 3.32c.13.23.39.32.6.22l2.39-.96c.5.4 1.06.7 1.63.94l.36 2.55c.04.24.25.42.5.42h3.84c.25 0 .46-.18.5-.42l.36-2.55c.57-.24 1.12-.54 1.63-.94l2.39.96c.21.1.47.01.6-.22l1.92-3.32a.5.5 0 00-.12-.64l-2.03-1.56zM12 15.5A3.5 3.5 0 1112 8.5a3.5 3.5 0 010 7z"/>
    </svg>
);
