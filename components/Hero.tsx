    ...
    <section id="hero" className="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden flex items-center">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-7xl font-bold text-white mb-6 leading-tight hero-title">
            Build AI That{' '}
          ...
          <h2 className="hero-subheadline text-lg md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
