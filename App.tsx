        ...
        <div className="mx-auto max-w-3xl px-6 py-16 lg:px-8 text-center">
          ...
          <Card className="mt-8 text-left bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-lg p-8">
            <form className="grid sm:grid-cols-2 gap-6" onSubmit={handleAssessmentSubmit}>
              ...
              <div className="sm:col-span-2">
                <Button type="submit" className="w-full h-12 px-8 rounded-xl cta-primary text-white font-bold text-base transform transition-transform duration-300 flex items-center justify-center">
      ...
      <section id="cta-close" className="bg-slate-800 text-white">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:py-24 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a href={bookingUrl} target="_blank" rel="noopener noreferrer" className="h-12 px-8 rounded-xl cta-primary text-white font-bold text-base transform transition-transform duration-300 flex items-center justify-center">Book Strategy Call</a>
